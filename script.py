#SciKit DSC540
'''Modified by Anirudh Pulavarthy for DSC-540 Advanced Machine Learning'''
'''Skeleton code created by Casey Bennett 2018, www.CaseyBennett.com'''
...
if binning==0 and cross_val==1:
    ...
    print("SVM - linear kernel + norm features + mutual info - RMSE:: %0.2f (+/- %0.2f)" % ((scores_RMSE.mean()), (scores_RMSE.std() * 2)))
    print("SVM - linear kernel + norm features + mutual info - Expl Var: %0.2f (+/- %0.2f)" % ((scores_Expl_Var.mean()), (scores_Expl_Var.std() * 2)))
